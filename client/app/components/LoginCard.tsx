...
const LoginCard = () => {
    ...
    return (
        <div className="-mt-2 rounded-lg pt-12 my-5 w-1/2 min-w-[350px] sm:min-w-[500px] mb-[200px] max-w-[600px] dark:bg-bbgray-900">
                ...
                <div className="flex items-center justify-center w-full">
                    <div className="flex items-center">
                        <form onSubmit={handleLogin} className="flex flex-col w-full h-full pb-6 text-center rounded-3xl">
                            ...
                            <button type="submit" className="mt-5 w-full px-6 py-5 mb-5 text-md font-bold leading-none text-white transition duration-300 md:w-96 rounded-md border border-gray-200 bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-100">
                                Sign In
                            </button>
